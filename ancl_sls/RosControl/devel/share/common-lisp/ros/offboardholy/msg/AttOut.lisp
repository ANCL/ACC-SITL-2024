...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AttOut>)))
  ...
  "8366b83287248a39a7aec7b15deddce3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AttOut)))
  "Returns md5sum for a message object of type 'AttOut"
  "8366b83287248a39a7aec7b15deddce3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AttOut>)))
  ...
  (cl:format cl:nil "#For attitude (roll, pitch, yaw) and controller outputs (3)~%Header header~%float64[3] rpy~%float64[3] con_out~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AttOut)))
  "Returns full string definition for message of type 'AttOut"
  (cl:format cl:nil "#For attitude (roll, pitch, yaw) and controller outputs (3)~%Header header~%float64[3] rpy~%float64[3] con_out~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
